...
Workflow
-----------------------------------------------
We provide a demo code in `cifar10_PM.py <https://github.com/securefederatedai/openfl/blob/develop/openfl-tutorials/experimental/workflow/LocalRuntime/Privacy_Meter/cifar10_PM.py>`_. Here, we briefly describe its workflow.
...
Examples
-----------------------------------------------
`Here <https://github.com/securefederatedai/openfl/tree/f1657abe88632d542504d6d71ca961de9333913f/openfl-tutorials/experimental/workflow/LocalRuntime/Privacy_Meter>`_, we give a few commands and the results for each of them. 
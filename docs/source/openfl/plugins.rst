...
|productName| components. Different plugins support varying usage scenarios.
...
Technically, a plugin is just a class, that implements some interface. One may enable a plugin by putting its 

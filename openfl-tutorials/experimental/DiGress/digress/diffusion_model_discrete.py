...
class DiscreteDenoisingDiffusion(pl.LightningModule):
    def __init__(self, cfg, dataset_infos, train_metrics, sampling_metrics, visualization_tools, extra_features,
        ...
        if self.cfg.model.transition == 'uniform':
        ...
        elif self.cfg.model.transition == 'marginal':
    ...
    def validation_step(self, data, i):
        ...
        # self.log_dict({'val loss': nll}, on_epoch=True)
    ...
    def on_validation_epoch_end(self) -> None:
        ...
        if getattr(getattr(self.cfg, 'guidance', None), 'use_guidance', False):
            ...
            self.log_dict({'val_nll': val_nll,
                           'Validity': self.sampling_metrics.rdkit_metrics[0][0],

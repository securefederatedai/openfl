...
class MVTecShardDescriptor(ShardDescriptor):
    ...
    def __init__(self, data_folder: str = 'MVTec_data',
        ...
        self.dataset_path = self.data_folder / 'mvtec_anomaly_detection'
        ...
        #setting imgs_path, can be changed to
    ...
    def download_data(data_folder):
        ...
        folder_path = data_folder / 'mvtec_anomaly_detection'

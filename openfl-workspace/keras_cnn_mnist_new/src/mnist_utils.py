...
def _load_raw_datashards(shard_num, collaborator_count):
    ...
    X_valid = X_valid[shard_num::collaborator_count]
    y_valid = y_valid[shard_num::collaborator_count]

    return (X_train, y_train), (X_valid, y_valid)


def load_mnist_shard(shard_num, collaborator_count, categorical=False,
                     **kwargs):
    """

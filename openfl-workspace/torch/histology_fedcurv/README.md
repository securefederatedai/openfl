...
Note that this example is similar to the one present in the `torch/histology` directory and is here to demonstrate the usage of a different aggregation algorithm using OpenFL's Taskrunner API.

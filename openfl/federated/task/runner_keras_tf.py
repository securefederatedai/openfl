...
class KerasTensorFlowTaskRunner(TaskRunner):
    ...
    def __init__(self, **kwargs):
        """Initializes the KerasTensorFlowTaskRunner instance.
        ...
        # functions in KerasTensorFlowTaskRunner
    ...
    def train_iteration(self, batch_generator, metrics: list = None, **kwargs):
        ...
        for param in metrics:
            if param not in results:
                raise ValueError(
                    f"KerasTensorFlowTaskRunner does not support specifying new metrics. "
    ...
    def _get_weights_dict(obj, suffix=""):
        ...
        """
        weights_dict = {}
        weight_names = KerasTensorFlowTaskRunner._get_weights_names(obj)
        if isinstance(obj, keras.optimizers.Optimizer):
            weights_dict = {

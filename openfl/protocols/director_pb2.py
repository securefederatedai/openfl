...
_GETEXPERIMENTSREQUEST = _descriptor.Descriptor(
    ...
    full_name='GetExperimentsRequest',
    filename=None,
    file=DESCRIPTOR,
    containing_type=None,
    create_key=_descriptor._internal_create_key,
...
_EXPERIMENTDESCRIPTIONLIST = _descriptor.Descriptor(
    name='ExperimentDescriptionList',
    full_name='ExperimentDescriptionList',
    filename=None,
    file=DESCRIPTOR,
    containing_type=None,
    create_key=_descriptor._internal_create_key,
    fields=[
        _descriptor.FieldDescriptor(
            name='experiments', full_name='ExperimentDescriptionList.experiments', index=0,
...
_EXPERIMENTDESCRIPTIONLIST.fields_by_name['experiments'].message_type = _EXPERIMENTDESCRIPTIONLIST
...
_COLLABORATORSTATUS.fields_by_name[
...
DESCRIPTOR.message_types_by_name['ExperimentDescriptionList'] = _EXPERIMENTDESCRIPTIONLIST
...
GetExperimentsRequest = _reflection.GeneratedProtocolMessageType('GetExperimentsRequest',
                                                                 (_message.Message,), {
                                                                     'DESCRIPTOR': _GETEXPERIMENTSREQUEST,
                                                                     '__module__': 'director_pb2'
                                                                     # @@protoc_insertion_point(class_scope:GetExperimentsRequest)
                                                                 })
...
ExperimentDescriptionList = _reflection.GeneratedProtocolMessageType('ExperimentDescriptionList',
                                                                     (_message.Message,), {
                                                                         'DESCRIPTOR': _EXPERIMENTDESCRIPTIONLIST,
                                                                         '__module__': 'director_pb2'
                                                                         # @@protoc_insertion_point(class_scope:ExperimentDescriptionList)
                                                                     })
_sym_db.RegisterMessage(ExperimentDescriptionList)
...
_FEDERATIONDIRECTOR = _descriptor.ServiceDescriptor(
    ...
    methods=[
        ...
        _descriptor.MethodDescriptor(
            name='GetExperiments',
            full_name='FederationDirector.GetExperiments',
            index=3,
            containing_service=None,
            input_type=_GETEXPERIMENTSREQUEST,
            output_type=_EXPERIMENTDESCRIPTIONLIST,
            serialized_options=None,
            create_key=_descriptor._internal_create_key,
        ),
        _descriptor.MethodDescriptor(

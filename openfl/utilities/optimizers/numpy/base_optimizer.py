...
class Optimizer(abc.ABC):
    ...
    This class serves as a base class for all optimizers. It defines the basic structure that all derived optimizer classes should follow. 
    It includes an abstract method `step` that must be implemented by any concrete optimizer class.
    """
    ...
    def _set_params_from_model(self, model_interface):
        ...
        This method is used to extract the parameters from the provided model interface and store them in the optimizer.

        Args:
            model_interface: The model interface instance to provide parameters.
        """

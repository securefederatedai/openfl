...
def parse_arguments():
    ...
    Returns:
        argparse.Namespace: Parsed command line arguments with the following attributes:
            ...
            - num_restarts (int): Number of times to restart the test
    ...
    try:
        ...
        parser.add_argument("--num_restarts", type=int, default=3, help="Number of times to restart the test. Default is 3")

...
# Memory logs related
AGG_MEM_USAGE_JSON = "{}/aggregator/workspace/logs/aggregator_memory_usage.txt"  # example - /tmp/my_federation/aggregator/workspace/logs/aggregator_memory_usage.txt
COL_MEM_USAGE_JSON = "{0}/{1}/workspace/logs/{1}_memory_usage.txt"  # example - /tmp/my_federation/collaborator1/workspace/logs/collaborator1_memory_usage.txt

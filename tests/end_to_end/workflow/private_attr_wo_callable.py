...
class TestFlowPrivateAttributesWoCallable(FLSpec):
    ...
    def start(self):
        ...
        validate_collab_private_attr(self, "test_loader_pvt", "start")
    ...
    def aggregator_step(self):
        ...
        """
        validate_collab_private_attr(self, "test_loader_pvt", "aggregator_step")
    ...
    def collaborator_step_a(self):
        ...
        validate_agg_private_attrs(
            self, "train_loader_pvt", "test_loader_pvt", "collaborator_step_a"
        )
    ...
    def collaborator_step_b(self):
        ...
        validate_agg_private_attrs(
            self, "train_loader_pvt", "test_loader_pvt", "collaborator_step_b"
        )
    ...
    def join(self, inputs):
        ...
        assert hasattr(self, "test_loader_pvt"), "aggregator_join_aggregator_attributes_missing"

        for idx, collab in enumerate(inputs):
            assert not (hasattr(collab, "train_loader_pvt") or hasattr(collab, "test_loader_pvt")), \
...
def validate_collab_private_attr(self, private_attr, step_name):
    ...
    This method checks that the aggregator has the specified private attribute
    and that the collaborators do not have access to certain private attributes.

    Args:
        private_attr (str): The name of the private attribute to check for the aggregator.
    ...
    Raises:
        ...
        AssertionError: If any collaborator has access to the specified private attributes.
    """
    # Aggregator should only be able to access its own attributes
...
def validate_agg_private_attrs(self, private_attr_1, private_attr_2, step_name):
    """
    Validates that the collaborator has access only to its own private attributes
    and that the runtime does not have access to the aggregator's private attributes.
    ...
    Args:
        ...
        step_name (str): The name of the step for error messaging.

    Raises:
        AssertionError: If the collaborator does not have the specified private attributes
                        or if the runtime has access to the aggregator's private attributes.
    """

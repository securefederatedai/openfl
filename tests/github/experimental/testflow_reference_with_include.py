...
class TestFlowReferenceWithInclude(FLSpec):
    ...
    def test_create_collab_attr(self):
        ...
        TestFlowReferenceWithInclude.step_one_collab_attrs.update(attr_collab_dict)
        ...
        if (
            ...
            matched_ref_dict = find_match_ref_at_step(
                collab_attr_list, TestFlowReferenceWithInclude.step_one_collab_attrs
            )
    ...
    def test_create_more_collab_attr(self):
        ...
        attr_collab_dict, collab_attr_list = create_collab_dict(self)
        TestFlowReferenceWithInclude.step_two_collab_attrs.update(attr_collab_dict)
        ...
        if (
            ...
            matched_ref_dict = find_match_ref_at_step(
                collab_attr_list, TestFlowReferenceWithInclude.step_two_collab_attrs
            )
            validate_references(matched_ref_dict)
